    ...
    <>
      ...
      <section className="social" ref={connectionRef}>
        <div className="social-inner">
          ...
          <ul>
            <li>
              <a href="https://www.instagram.com/lor_jarroh_qurbonov?igsh=MW1qbXJpeDZncTgwNA%3D%3D&utm_source=qr">
                <img src={icons.instagram} alt="Иконка инстраграм" />
              </a>
            </li>
            <li>
              <a href="https://www.facebook.com/profile.php?id=61557999111744&mibextid=LQQJ4d">
                <img src={icons.facebook} alt="Иконка Фейсбука" />
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="https://www.youtube.com/@Lorjarroh">
